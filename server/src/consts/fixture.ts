...
rnd_avdienko|CN=Авдиенко Анастасия,OU=RND,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users;IPG_Management_M-A-M;IPG_Management_M-A-K;IPG_Buhgalteria
rnd_grigorieva|CN=Григорьева,OU=RND,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users
rnd_audit|CN=Аудит,OU=RND,DC=IPG,DC=LOCAL|False|1601-01-01|Domain Users
rnd_hucishvilly|CN=Хуцишвилли,OU=RND,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users
rnd_office|CN=Офис РНД,OU=RND,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users
rnd_belokobilskay|CN=Белокобыльская,OU=RND,DC=IPG,DC=LOCAL|False|1601-01-01|Domain Users
rnd_sabich|CN=Сабич,OU=RND,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users
msk_muraveva|CN=Муравьёва,OU=MSK,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users;IPG_Management_M-A-M;IPG_Buhgalteria
rnd_providohin|CN=Провидохин,OU=RND,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users
rnd_sklad|CN=Скад,OU=RND,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users
volga_urtanova|CN=Уртанова,OU=VLG,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users
rnd_gugevin|CN=Гужевин,OU=RND,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users
msk_vasileva|CN=Васильева,OU=MSK,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users;IPG_Buhgalteria
rnd_vatulina|CN=Ватулина,OU=MSK,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users
krm_kuzma|CN=Кузьма,OU=CRM,DC=IPG,DC=LOCAL|False|1601-01-01|Domain Users
krm_chumak|CN=Чумак,OU=CRM,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users
rnd_larin|CN=Ларин,OU=RND,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users
rnd_sergeev|CN=Сергеев,OU=RND,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users
rnd_gorbachev|CN=Горбачёв,OU=RND,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users;IPG_Management;IPG_Management_M-A-M;IPG_Documentation
rnd_komarov|CN=Комаров,OU=RND,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users
msk_zarev|CN=Царёв,OU=MSK,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users;Controller_Temp130223Sam;IPG_Production;IPG_Controller
krm_saidov|CN=Саидов,OU=CRM,DC=IPG,DC=LOCAL|False|1601-01-01|Domain Users
1cadmin|CN=1С пользователь,CN=Users,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users;1C
msk_morozova|CN=Морозова,OU=MSK,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users
msk_shavkin|CN=Шавкин,OU=MSK,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users;Controller_Temp130223Sam;IPG_Production;IPG_Controller;IPG_Buhgalteria
krn_marchenkova|CN=Марченкова,OU=KRN,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users
msk_chprasov|CN=Чепасов,OU=MSK,DC=IPG,DC=LOCAL|False|1601-01-01|Domain Users
msk_chekunov|CN=Чекунов,OU=MSK,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users
krm_vasilkovsky|CN=Васильковский,OU=CRM,DC=IPG,DC=LOCAL|False|1601-01-01|Domain Users
krm_shipilov|CN=Шипилов,OU=CRM,DC=IPG,DC=LOCAL|False|1601-01-01|Domain Users
msk_muravev|CN=Муравьёв,OU=MSK,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users;Controller_Temp130223Sam;IPG_Production;IPG_Controller;IPG_Management_M-A-M;IPG_Management_M-A-K;IPG_Documentation;IPG_Buhgalteria
rnd_careva|CN=Царёва,OU=RND,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users;Controller_Temp130223Sam;IPG_Production;IPG_Controller
msk_kosobochkina|CN=Кособочкина,OU=MSK,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users
spb_laiming|CN=Лайминг,OU=SPB,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users
spb_morozova|CN=Морозова,OU=SPB,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users
krn_zotov|CN=Зотов,OU=KRN,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users
volga_sidorov|CN=Сидоров,OU=VLG,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users
rnd_glavbuh|CN=Главбух,OU=RND,DC=IPG,DC=LOCAL|False|1601-01-01|Domain Users
rnd_kuznezova|CN=Кузнецова,OU=RND,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users
rnd_gutiryk|CN=Гутирук,OU=RND,DC=IPG,DC=LOCAL|False|1601-01-01|Domain Users
...
spb_aleksandrova|CN=Александрова,OU=SPB,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users
krm_harchev|CN=Харчев Александр Юрьевич,OU=CRM,DC=IPG,DC=LOCAL|False|1601-01-01|Domain Users
krm_kuzmina|CN=Кузьмина Лилия Ринатовна,OU=CRM,DC=IPG,DC=LOCAL|False|1601-01-01|Domain Users
krm_ulitina|CN=Улитина Оксана Сергеевна,OU=CRM,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users
krm_mechanic|CN=механик,OU=CRM,DC=IPG,DC=LOCAL|False|1601-01-01|Domain Users
rnd_elitaudit|CN=Элит Аудит,OU=RND,DC=IPG,DC=LOCAL|False|1601-01-01|Domain Users
...
krn_jevkiak|CN=Жевтяк Валерий Васильевич,OU=KRN,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users
krn_sedunov|CN=Седунов Иван Викторович,OU=KRN,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users
krm_kovalev|CN=Ковалев Сергей,OU=CRM,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users
krm_kravchenko|CN=Кравченко Оксана Васильевна,OU=CRM,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users;IPG_Management_M-A-K
krm_yakovleva|CN=Яковлева О.В.,OU=CRM,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users
rnd_gym|CN=Спортзал РНД,OU=RND,DC=IPG,DC=LOCAL|False|1601-01-01|Domain Users
krm_agapova|CN=Агапова Наталья,OU=CRM,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users
krm_knyzev|CN=Князев Михаил Александрович,OU=CRM,DC=IPG,DC=LOCAL|False|1601-01-01|Domain Users
msk_guest|CN=Гость,OU=MSK,DC=IPG,DC=LOCAL|False|1601-01-01|Domain Users
krm_lashenova|CN=Лащенова Анастасия Викторовна,OU=CRM,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users
krm_guest|CN=Крым Гость,OU=CRM,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users
krm_momot|CN=Момот Сергей Викторович,OU=KRN,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users
krm_ososkova|CN=Ососкова Т.Ф.,OU=CRM,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users
krm_batorshina|CN=Баторшина Виолетта Рашидовна,OU=CRM,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users
rkm_prebuh|CN=Плебух Лидия Анатольевна,OU=CRM,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users
msk_warehouse|CN=Склад Москва,OU=MSK,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users
rnd_vashenko|CN=Ващенко Михаил,OU=RND,DC=IPG,DC=LOCAL|False|1601-01-01|Domain Users
rnd_stepochkin|CN=Степочкин Денис,OU=RND,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users;RND
rnd_bluslenko|CN=Брусленко Наталья,OU=RND,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users;RND
rnd_controller|CN=Контролер,OU=RND,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users;IPG_Controller
krn_begun|CN=Мищенко Николай,OU=RND,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users
rnd_mishenko|CN=Мищенко Николай,CN=Users,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users
...
krm_eshmanova|CN=Эмшанова Елена Васильевна,OU=CRM,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users;IPG_Buhgalteria
...
volga_jabkin|CN=Жабкин А.И.,OU=VLG,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users
volga_zobov|CN=Зобов С.А.,OU=VLG,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users
ksekret|CN=ksekret,OU=RND,DC=IPG,DC=LOCAL|True|1601-01-01|Domain Users;IPG_Documentation`;
